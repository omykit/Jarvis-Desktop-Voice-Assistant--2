...
Configure your assistant name, AI model, voice settings, and WeatherAPI key in `jarvis_config.json` — see the full reference in the [project report](./docs/Jarvis_Project_Report.pdf).
